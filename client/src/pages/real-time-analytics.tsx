        ...
        <Card className="government-card">
          ...
          <CardContent>
            <div className="h-[450px] w-full">
              {mapProvider === 'google' ? (
                <GoogleMapsJamaica parishStats={heatMapData} selectedMetric="incidents" onParishSelect={() => {}} selectedParish={null} />
              ) : (
                <HereMapsJamaica parishStats={heatMapData} selectedMetric="incidents" onParishSelect={() => {}} selectedParish={null} />
              )}
            </div>
          </CardContent>
        </Card>
